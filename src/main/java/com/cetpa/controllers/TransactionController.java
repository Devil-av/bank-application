...
public class TransactionController 
{
	...
	@GetMapping("transfer")
	public String getTransferMoneyView(HttpSession ses)
	{
		if(ses.getAttribute("username")==null)
		{
			return "redirect:/mybank/user/login";
	...
	public String transferAmount(int amount,int accountNumber,Model model,HttpSession ses)
	{
		if(ses.getAttribute("username")==null)
		{
			return "redirect:/mybank/user/login";
		...
		Account otherAccount = accountService.getAccount(accountNumber); 
		if(otherAccount==null) {
			model.addAttribute("msg","Account number is incorrect");
		...
		accountService.transferMoney(amount,an,accountNumber);
		model.addAttribute("amount",amount);
		model.addAttribute("accountNumber",accountNumber);
